// Path and File Name : /home/ransomeye/rebuild/ransomeye_dpi_probe/probe/security/attestation.rs
...
impl AttestationManager {
    ...
    pub fn create(identity: &ComponentIdentity, verifying_key: &VerifyingKey) -> Result<Attestation, ProbeError> {
        ...
        let mut attestation = Attestation {
            ...
            attestation_hash: String::new(), // Will be computed
            timestamp,
        };
    ...
    /// Verify attestation
    pub fn verify(attestation: &Attestation) -> Result<bool, ProbeError> {
    ...
    /// Compute attestation hash
    fn compute_hash(attestation: &Attestation) -> Result<String, ProbeError> {
