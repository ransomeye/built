// Path and File Name : /home/ransomeye/rebuild/ransomeye_policy/output/directive.rs
...
impl DirectiveGenerator {
    ...
    pub fn generate(&self, decision: &crate::engine::decision::PolicyDecision, ttl_seconds: u64) -> Result<EnforcementDirective, Box<dyn std::error::Error>> {
